...
function EditForm({handleCreateWork , handleEditWork}) {
          ...
          <div className='flex gap-4'>
            <div className='main w-1/2'>
              ...
              <div className="relative mb-3">
                <label htmlFor="exampleURL0" className="form-label inline-block mb-2 text-gray-700">實習/方舟</label>
                  <div className="flex items-center mb-4">
                      <input  id="department-radio-1" type="radio" value="夢想實習" name="default-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {...register("department")}/>
                      <label htmlFor="department-radio-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">夢想實習</label>
                  </div>
                  <div className="flex items-center">
                      <input  id="department-radio-2" type="radio" value="夢想方舟" name="default-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"  {...register("department")}/>
                      <label htmlFor="department-radio-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">夢想方舟</label>
                  </div>
